 ...
 * @author Troy Nguyen
 * 12/12/16
 * Advent of Code day 2, 2015, problem 2
 */

function ribbonFinder(dimensionString) {
	var firstXLocation;
	var secXLocation;
	...
	var perimeters = [findPerimeter(l, w), findPerimeter(w, h), findPerimeter(l, h)];
	
	// This is super dope. I just declare an object like this, and then return it. I'm pretty much returning multiple values in one function!
	var giftDims = {
		// holy shit Gauri this is super cool. I literally pass in an UNNAMED comparator function into the standard "sort" function
		minPerim: perimeters.sort(function(a,b) { return a - b })[0],
		volume: l * w * h
	};
